...
// copy of driver level ioctl command enumberations
#define GET_BUFFER_CAPACITY   _IOR(__CANONICAL_CHAR_DRV_IOC, 1, int) /* total capacity of buffer */
#define GET_BUFFER_SIZE       _IOR(__CANONICAL_CHAR_DRV_IOC, 2, int) /* used buffer size */
